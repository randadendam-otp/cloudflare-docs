...
- **Tools** give the agent capabilities: [browser automation](/agents/tools/browser/), [sandboxed code execution](/agents/tools/sandbox/), [AI Search](/agents/tools/rag/), [MCP tools](/agents/tools/mcp/), and [payments](/agents/tools/payments/).
...
Build an agent that can pay for x402-protected tools.

</RelatedProduct>

<RelatedProduct header="Retrieval Augmented Generation agent" href="/agents/examples/retrieval-augmented-generation-agent/" product="ai-search">

Build an agent with Retrieval Augmented Generation and AI Search.

</RelatedProduct>

<RelatedProduct header="Code review agent" href="/agents/examples/code-review-agent/" product="sandbox">

Build an agent that reviews pull requests using Sandbox and Claude.
