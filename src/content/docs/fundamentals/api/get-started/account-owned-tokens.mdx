Cloudflare: a03dd1e08ae62652
IP Anda: 2400:9800:590:5db4:2437:77ff:fe42:27e7---
...
New account API tokens use the `cfat_` prefixed [scannable format](/fundamentals/api/get-started/token-formats/), which allows credential scanning tools to detect leaked tokens.
